...
PATH_CREATE_VERIFICATION_PROCESS = '/verification'.freeze
PATH_UPDATE_VERIFICATION_PROCESS = '/verification/%{reference_id}/state'.freeze
PATH_RETRIEVE_VERIFICATION_PROCESS = '/verification/%{reference_id}'.freeze
...
module TelesignEnterprise
  ...
  class OmniVerifyClient < Telesign::RestClient
    ...
    def create_verification_process(phone_number, **params)
      ...
      post(PATH_CREATE_VERIFICATION_PROCESS, **params)
    end
    ...
    def retrieve_verification_process(reference_id, **params)
      get(format(PATH_RETRIEVE_VERIFICATION_PROCESS, reference_id: reference_id), **params)
    end
    ...
    def update_verification_process(reference_id, **params)
      patch(format(PATH_UPDATE_VERIFICATION_PROCESS, reference_id: reference_id), auth_method: 'Basic', **params)
    end
